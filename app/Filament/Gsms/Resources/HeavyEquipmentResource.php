...
use App\Livewire\Gsms\HeavyEquipmentInsurances;
use Illuminate\Database\Eloquent\SoftDeletingScope;
use App\Livewire\Gsms\HeavyEquipmentOfficialReceipts;
use pxlrbt\FilamentExcel\Actions\Tables\ExportAction;
use App\Filament\Gsms\Resources\HeavyEquipmentResource\Pages;
use Livewire\Features\SupportFileUploads\TemporaryUploadedFile;
use App\Filament\Gsms\Resources\HeavyEquipmentResource\RelationManagers;
...
class HeavyEquipmentResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Heavy Equipment';
        ...
        return $table
            ->headerActions([
                ExportAction::make()->exports([
                    ExcelExport::make('table')->fromTable()->withFilename('Heavy Equipment Export - '.date('F d, Y')),
                ])->color('success'),

            ])
            ->columns([
                Tables\Columns\TextColumn::make('heavyEquipmentType.name')
                    ->label('Type')
                    ->searchable()
                    ->toggleable(),
            ...
            ->actions([
                Action::make('details')
                    ...
                    ->infolist([
                        ...
                        ->schema([
                            TextEntry::make('heavyEquipmentType.name'),
                            ...
                            Split::make([
                                ...
                                ->schema([
                                        Livewire::make(HeavyEquipmentOfficialReceipts::class)
                                ]),
                                Section::make('Insurance Policies')
                                ->schema([
                                        Livewire::make(HeavyEquipmentInsurances::class)
                                ]),
                            ])
                        ]),
                ...
                ->steps([
                        ...
                        Forms\Components\Select::make('status')
                            ->options([
                                'Goood Running Condition' => 'Goood Running Condition',
                                'Running Condition' => 'Running Condition',
                                'Unserviceable' => 'Unserviceable',
                            ]),
                        ]),
