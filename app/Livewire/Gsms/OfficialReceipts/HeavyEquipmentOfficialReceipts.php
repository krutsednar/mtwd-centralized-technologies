...
class HeavyEquipmentOfficialReceipts extends Component implements HasForms, HasTable
{
    ...
    {
        return $table
            ->query(HeavyEquipmentOfficialReceipt::query())
            ->headerActions([
    ...
    {
        return view('livewire.gsms.official-receipts.heavy-equipment-official-receipts');
    }
}
