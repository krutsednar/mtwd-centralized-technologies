...
<html>
<head>
    <title>DTR — {{ $profile->full_name }} — {{ $start->format('M d, Y') }} to {{ $end->format('M d, Y') }}</title>
    <style>
        @page {
            size: 8.5in 13in;
...
<div class="print-bar no-print">
    <form method="GET" action="{{ route('dtr.print', $profile->id) }}" style="display:flex;align-items:center;gap:12px;width:100%">

        <label>Start Date:
            <input type="date" name="start_date" value="{{ $start->toDateString() }}"
                   style="padding:4px 8px;border-radius:4px;border:none;font-size:12px;">
        </label>
    ...
    <div class="dtr">
        ...
        <div class="info-section">
            ...
            <div class="info-row">
                ...
                <span class="value">{{ strtoupper($profile->division?->name ?? '') }}</span>
            </div>
            <div class="info-row">
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th colspan="2" style="width:28.5%">AM</th>
                    <th colspan="2" style="width:28.5%">PM</th>
                    <th colspan="2" style="width:29%">OT</th>
                </tr>
                <tr>
                    <th>In</th><th>Out</th>
                    <th>In</th><th>Out</th>
